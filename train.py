...
def train_inv(data_batch, args, autoencoder, gan_gen, inverter, optimizer_inv,
    ...
    if args.use_inv_ae:
        ...
        fake_hidden = gan_gen(noise, labels)
        inv_noise = inverter(fake_hidden, labels)
        ...
        if data_batch:
            ...
            real_noise = inverter(real_hidden, labels)
            hidden = gan_gen(real_noise, labels)
            errI = gamma * errI
            ...
            for k in range(niter_gan):
                ...
                if args.update_base:
                    ...
                    for i in range(args.niters_gan_g):
                        errG = train_gan_g(train_data[niter - 1], args, gan_gen, gan_disc, optimizer_gan_g)
